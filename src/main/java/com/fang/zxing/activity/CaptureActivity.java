...
import com.fang.zxing.decoding.InactivityTimer;
import com.fang.zxing.view.ViewfinderView;
...
public class CaptureActivity extends BaseActivity implements Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		lightButton = (Button)findViewById(R.id.btn_light);
		hasSurface = false;
	...
	protected void onResume() {
		...
		lightButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (isLightOn) {
					isLightOn = false;
					lightButton.setText(R.string.light_on);
					CameraManager.get().offLight();
				}else {
					isLightOn = true;
					lightButton.setText(R.string.light_off);
